...
while True:
    try:
        ...
        days_time = datetime.timedelta(days=1)
        print(str(type(start_time.to_pydatetime())))
        print("2 "+ str(type(start_time)) + " " + str(type(datetime.timedelta(days=1))))

        end_time = start_time + datetime.timedelta(days=1)
        print("3 "+(str)(upbit.get_avg_buy_price("ETH")))
        if upbit.get_avg_buy_price("ETH") is None :
            avg_price = 0
        else :
