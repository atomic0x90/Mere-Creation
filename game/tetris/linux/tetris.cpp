...
void scoreAlgorithm()
{
	...
	if(clearLine != 0)
	{
		...
		if(clearLine == 1)
			tmpsc += linesc * comsc * 1.0;
		else if(clearLine == 2)
			tmpsc += linesc * comsc * 2.1;
		else if(clearLine == 3)
			tmpsc += linesc * comsc * 3.2;
		else if(clearLine == 4)
			tmpsc += linesc * comsc * 4.4;
	}
	else
		combo = 0;
...
int rotationAlgorithm(int input)
{
	...
	else if(nowData == 4)	//S
	{
		if(rotationState == 1)
		{
			if(input == 120)	//Clockwise
			{
				...
				{	//When null 7.11
					...
					tetrisData[save1[1]+1][save2[1]] = tetrisData[save1[1]+2][save2[1]] = tmp;
				
					return 2;
				}
				else if(tetrisData[save1[0]][save2[0]-1] == 0 && tetrisData[save1[3]+1][save2[3]] == 0)
				{	//When null 1.10
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[1]][save2[1]] = 0;

					tetrisData[save1[0]][save2[0]-1] = tetrisData[save1[3]+1][save2[3]] = tmp;
				
					return 2;
				}
				else if(tetrisData[save1[0]-1][save2[0]] == 0 && tetrisData[save1[1]+1][save2[1]] == 0)
				{	//When null 7 up.2
					tetrisData[save1[2]][save2[2]] = 0;
					tetrisData[save1[3]][save2[3]] = 0;

					tetrisData[save1[0]-1][save2[0]] = tetrisData[save1[1]+1][save2[1]] = tmp;
			...
			{
				if(tetrisData[save1[0]][save2[0]-1] == 0 && tetrisData[save1[3]+1][save2[3]] == 0)
                                {       //When null 1.10
                                        tetrisData[save1[0]][save2[0]] = 0;
                                        tetrisData[save1[1]][save2[1]] = 0;
				...
				else if(tetrisData[save1[1]+1][save2[1]] == 0 && tetrisData[save1[1]+2][save2[1]] == 0)
                                {       //When null 7.11
                                        tetrisData[save1[1]][save2[1]] = 0;
                                        tetrisData[save1[2]][save2[2]] = 0;
		...
		{
			if(tetrisData[save1[1]+1][save2[1]] == 0 && tetrisData[save1[2]][save2[2]+1] == 0)
			{	//When null 9 7
				tetrisData[save1[0]][save2[0]] = 0;
				tetrisData[save1[1]][save2[1]] = 0;

				tetrisData[save1[1]+1][save2[1]] = tetrisData[save1[2]][save2[2]+1] = tmp;
			
				return 1;
			}
			else if(tetrisData[save1[1]+1][save2[1]] == 0 && tetrisData[save1[1]+1][save2[1]-1] == 0)
			{	//When null 9 left.9
				tetrisData[save1[0]][save2[0]] = 0;
				tetrisData[save1[3]][save2[3]] = 0;

				tetrisData[save1[1]+1][save2[1]] = tetrisData[save1[1]+1][save2[1]-1] = tmp;
			...
			else if(tetrisData[save1[0]][save2[0]+1] == 0 && tetrisData[save1[1]][save2[1]-1] == 0)
			{	//When null 2 left.5
				tetrisData[save1[2]][save2[2]] = 0;
				tetrisData[save1[3]][save2[3]] = 0;

				tetrisData[save1[0]][save2[0]+1] = tetrisData[save1[1]][save2[1]-1] = tmp;
	...
	else if(nowData == 5)	//T
	{
		if(rotationState == 1)
		{
			if(input == 120)	//Clockwise
			{
				if(tetrisData[save1[1]-1][save2[1]] == 0)
				{	//When null 2
					tetrisData[save1[2]][save2[2]] = 0;
				...
				else if(tetrisData[save1[3]][save2[3]-1] == 0 && tetrisData[save1[3]+1][save2[3]] == 0)
				{	//When null 9 14
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[2]][save2[2]] = 0;

					tetrisData[save1[3]][save2[3]-1] = tetrisData[save1[3]+1][save2[3]] = tmp;
		...
		else if(rotationState == 2)
		{
			if(input == 120)	//Clockwise
			{
				if(tetrisData[save1[2]][save2[2]+1] == 0)
				{	//When null 7
					tetrisData[save1[3]][save2[3]] = 0;
			...
			else if(input == 122)	//Counterclockwise
			{
				...
				else if(tetrisData[save1[3]][save2[3]-1] == 0 && tetrisData[save1[3]][save2[3]+1] == 0 && tetrisData[save1[3]+1][save2[3]] == 0)
				{	//When null 9 11 14
					for(int i = 0;i < 3;i++)
						tetrisData[save1[i]][save2[i]] = 0;

					tetrisData[save1[3]][save2[3]-1] = tetrisData[save1[3]][save2[3]+1] = tetrisData[save1[3]+1][save2[3]] = tmp;
		...
		else if(rotationState == 3)
		{
			if(input == 120)	//Clockwise
			{
				if(tetrisData[save1[2]+1][save2[2]] == 0)
				{	//When null 10
					tetrisData[save1[1]][save2[1]] = 0;
				...
				else if(tetrisData[save1[3]-1][save2[3]] == 0 && tetrisData[save1[3]][save2[3]+1] == 0 && tetrisData[save1[3]+1][save2[3]] == 0)
				{	//When null 3 8 11
					for(int i = 0;i < 3;i++)
						tetrisData[save1[i]][save2[i]] = 0;

					tetrisData[save1[3]-1][save2[3]] = tetrisData[save1[3]][save2[3]+1] = tetrisData[save1[3]+1][save2[3]] = tmp;
			...
			else if(input == 122)	//Counterclockwise
			{
				...
				else if(tetrisData[save1[1]-1][save2[1]] == 0 && tetrisData[save1[1]][save2[1]-1] == 0 && tetrisData[save1[1]+1][save2[1]] == 0)
				{	//When null 1 left.5 9
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[2]][save2[2]] = 0;
					tetrisData[save1[3]][save2[3]] = 0;

					tetrisData[save1[1]-1][save2[1]] = tetrisData[save1[1]][save2[1]-1] = tetrisData[save1[1]+1][save2[1]] = tmp;
		...
		else if(rotationState == 4)
		{
			if(input == 120)	//Clockwise
			{
				if(tetrisData[save1[1]][save2[1]-1] == 0)
				{	//When null 5
					tetrisData[save1[0]][save2[0]] = 0;

					tetrisData[save1[1]][save2[1]-1] = tmp;
			...
			else if(input == 122)	//Counterclockwise
			{
				...
				else if(tetrisData[save1[3]][save2[3]-1] == 0 && tetrisData[save1[3]][save2[3]+1] == 0)
				{	//When null 9 11
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[2]][save2[2]] = 0;

					tetrisData[save1[3]][save2[3]-1] = tetrisData[save1[3]][save2[3]+1] = tmp;
	...
	else if(nowData == 6)	//Z
	{
		if(rotationState == 1)
		{
			if(input == 120)	//Clockwise
			{
				if(tetrisData[save1[1]][save2[1]+1] == 0 && tetrisData[save1[2]+1][save2[2]] == 0)
				{	//When null 3 10
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[1]][save2[1]] = 0;

					tetrisData[save1[1]][save2[1]+1] = tetrisData[save1[2]+1][save2[2]] = tmp;
				
					return 2;
				}
				else if(tetrisData[save1[0]+1][save2[0]] == 0 && tetrisData[save1[0]+2][save2[0]] == 0)
				{	//When null 5 9
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[3]][save2[3]] = 0;

					tetrisData[save1[0]+1][save2[0]] = tetrisData[save1[0]+2][save2[0]] = tmp;
				
					return 2;
				}
				else if(tetrisData[save1[3]-1][save2[3]] == 0 && tetrisData[save1[3]-2][save2[3]] == 0)
				{	//When null 3 up.3
					tetrisData[save1[0]][save2[0]] = 0;
					tetrisData[save1[3]][save2[3]] = 0;

					tetrisData[save1[3]-1][save2[3]] = tetrisData[save1[3]-2][save2[3]] = tmp;
			...
			{
				if(tetrisData[save1[0]+1][save2[0]] == 0 && tetrisData[save1[0]+2][save2[0]] == 0)
                                {       //When null 5 9
                                        tetrisData[save1[0]][save2[0]] = 0;
                                        tetrisData[save1[3]][save2[3]] = 0;
				...
				else if(tetrisData[save1[1]][save2[1]+1] == 0 && tetrisData[save1[2]+1][save2[2]] == 0)
                                {       //When null 3 10
                                        tetrisData[save1[0]][save2[0]] = 0;
                                        tetrisData[save1[1]][save2[1]] = 0;
		...
		{
			if(tetrisData[save1[3]][save2[3]+1] == 0 && tetrisData[save1[1]][save2[1]-1] == 0)
			{	//When null 10 left.5
				tetrisData[save1[0]][save2[0]] = 0;
				tetrisData[save1[2]][save2[2]] = 0;

				tetrisData[save1[3]][save2[3]+1] = tetrisData[save1[1]][save2[1]-1] = tmp;
			...
			else if(tetrisData[save1[0]][save2[0]-1] == 0 && tetrisData[save1[2]][save2[2]+1] == 0)
			{	//When null 1 7
				tetrisData[save1[1]][save2[1]] = 0;
				tetrisData[save1[3]][save2[3]] = 0;

				tetrisData[save1[0]][save2[0]-1] = tetrisData[save1[2]][save2[2]+1] = tmp;
