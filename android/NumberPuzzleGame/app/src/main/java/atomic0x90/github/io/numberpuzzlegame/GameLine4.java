...
//Sound
        ...
        mAdView = findViewById(R.id.Line4adView);
                    ...
                    if(MiddleButton1.isSelected()){
                        ...
                        if(Mid1Arr[0] == finalIntAnswer[AnswerNow[0]]){
                            ...
                            if(AnswerNow[0] == MaxNum){
                                ...
                                CustomDialog customDialog = new CustomDialog(GameLine4.this);
    ...
    public void onBackPressed(){
        CustomDialogBackKey costomDialog = new CustomDialogBackKey(GameLine4.this);
