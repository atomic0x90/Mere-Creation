...
public class GameLine3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_line3);

        //ad


        mAdView = findViewById(R.id.Line3adView);
        ...
        final TextView TitleText = (TextView) findViewById(R.id.Line3Title);
        final Button TopButton = (Button) findViewById(R.id.Line3TopButton);
        final Button MiddleButton1 = (Button) findViewById(R.id.Line3MiddleButton1);
        final Button MiddleButton2 = (Button) findViewById(R.id.Line3MiddleButton2);
        final Button MiddleButton3 = (Button) findViewById(R.id.Line3MiddleButton3);
        final Button BottomButton = (Button) findViewById(R.id.Line3BottomButton);

        Button RetryButton = (Button) findViewById(R.id.Line3RetryButton);
        ...
        BottomButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(!MiddleButton1.isSelected() && !MiddleButton2.isSelected() && !MiddleButton3.isSelected()){
                    ...
                    if(MiddleButton1.isSelected()){
                        ...
                        if(Mid1Arr[0] == finalIntAnswer[AnswerNow[0]]){
                            ...
                            if(AnswerNow[0] == MaxNum){
                                ...
                                CustomDialog customDialog = new CustomDialog(GameLine3.this);
    ...
    public void onBackPressed(){
        CustomDialogBackKey costomDialog = new CustomDialogBackKey(GameLine3.this);
