...
//Sound
        ...
        final TextView TitleText = (TextView) findViewById(R.id.Line5Title);
        final Button TopButton = (Button) findViewById(R.id.Line5TopButton);
        final Button MiddleButton1 = (Button) findViewById(R.id.Line5MiddleButton1);
        final Button MiddleButton2 = (Button) findViewById(R.id.Line5MiddleButton2);
        final Button MiddleButton3 = (Button) findViewById(R.id.Line5MiddleButton3);
        final Button MiddleButton4 = (Button) findViewById(R.id.Line5MiddleButton4);
        final Button MiddleButton5 = (Button) findViewById(R.id.Line5MiddleButton5);
        final Button BottomButton = (Button) findViewById(R.id.Line5BottomButton);

        Button RetryButton = (Button) findViewById(R.id.Line5RetryButton);
        ...
        final String NowTitle = nowIntent.getStringExtra("LV"); //어떤 단계

        TitleText.setText(NowTitle);
        ...
        RetryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MiddleButton5.setSelected(false);
            ...
            public void onClick(View view) {
                ...
                if(TopButton.isSelected()){
                    ...
                    if(!MiddleButton1.isSelected()){
                        ...
                        MiddleButton5.setEnabled(false);
                    }
                    else{
                        MiddleButton1.setSelected(false);
        ...
        MiddleButton5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TopButton.isSelected()){
                    ...
                    String tmpString = "";
                    for(int i = Mid5Tail[0]-1 ;i >= 0; i--){
                        tmpString += "\n" + Mid5Arr[i];
                    }
                    MiddleButton5.setText(tmpString);
                    ...
                    //Middle에서 선택 후 Bottom으로 옮길 때
                    if(!MiddleButton5.isSelected()){
                        //선택 안됐을 때
                        MiddleButton5.setSelected(true);
        ...
        BottomButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!MiddleButton1.isSelected() && !MiddleButton2.isSelected() && !MiddleButton3.isSelected() && !MiddleButton4.isSelected() && !MiddleButton5.isSelected()){
                    ...
                    else if(MiddleButton5.isSelected()){
                        //5번 줄에서 내려온 경우
                        if(Mid5Arr[0] == finalIntAnswer[AnswerNow[0]]) {
                            //숫자가 맞을 경우
                            //text
                            String nowAnswer = String.valueOf(finalIntAnswer[AnswerNow[0]]);
                            ...
                            //
                            for (int i = 0; i < Mid5Tail[0]; i++) {
                                Mid5Arr[i] = Mid5Arr[i + 1];
                            }
                            Mid5Arr[Mid5Tail[0]] = 0;
