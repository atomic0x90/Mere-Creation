...
public class Challenge_multi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_challenge_multi);
        ...
        final TextView timetextView = (TextView)findViewById(R.id.multiText);
        ...
        final CountDownTimer countDownTimer = new CountDownTimer(11000, 1000) {
            ...
            public void onFinish() {
                ...
                {
                    Intent intent = new Intent(getApplicationContext(), Challenge_multi.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        TextView averageText = (TextView)findViewById(R.id.multiAverageTime);
        ...
        {
            ImageView imageView0 = (ImageView)findViewById(R.id.multiState0);
            ImageView imageView1 = (ImageView)findViewById(R.id.multiState1);
            ImageView imageView2 = (ImageView)findViewById(R.id.multiState2);
            ImageView imageView3 = (ImageView)findViewById(R.id.multiState3);
            ImageView imageView4 = (ImageView)findViewById(R.id.multiState4);
            ImageView imageView5 = (ImageView)findViewById(R.id.multiState5);
            ImageView imageView6 = (ImageView)findViewById(R.id.multiState6);
            ImageView imageView7 = (ImageView)findViewById(R.id.multiState7);
            ImageView imageView8 = (ImageView)findViewById(R.id.multiState8);
            ImageView imageView9 = (ImageView)findViewById(R.id.multiState9);
        ...
        int rand1 = random.nextInt(15)+3;

        random.setSeed(System.currentTimeMillis());

        int randseed = random.nextInt(10)+2;
        int rand2 = random.nextInt(randseed)+5;
        ...
        TextView resultText1 = (TextView)findViewById(R.id.cmul1);
        TextView resultText2 = (TextView)findViewById(R.id.cmul2);
        TextView resultText3 = (TextView)findViewById(R.id.cmul3);
        TextView resultText4 = (TextView)findViewById(R.id.cmul4);
        ...
        TextView  problemView1 = (TextView)findViewById(R.id.multiProblemText1);
        problemView1.setText(String.valueOf(rand1));

        TextView problemView2 = (TextView)findViewById(R.id.multiProblemText2);
        problemView2.setText(String.valueOf(rand2));


        //버튼 눌렀을 경우
        Button button1 = (Button)findViewById(R.id.cmul1);
        Button button2 = (Button)findViewById(R.id.cmul2);
        Button button3 = (Button)findViewById(R.id.cmul3);
        Button button4 = (Button)findViewById(R.id.cmul4);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tmpNumber != 10) {
                    ...
                    TextView resultText = (TextView) findViewById(R.id.cmul1);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tmpNumber != 10) {
                    ...
                    TextView resultText = (TextView) findViewById(R.id.cmul2);
                    String tmp = resultText.getText().toString();
                    if (result == Integer.parseInt(tmp))
                        answerResult[problemNumber] = 1;
                    else
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tmpNumber != 10){
                    ...
                    TextView resultText = (TextView) findViewById(R.id.cmul3);
                    String tmp = resultText.getText().toString();
                    if (result == Integer.parseInt(tmp))
                        answerResult[problemNumber] = 1;
                    else
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tmpNumber != 10) {
                    ...
                    TextView resultText = (TextView) findViewById(R.id.cmul4);
                    String tmp = resultText.getText().toString();
                    if (result == Integer.parseInt(tmp))
                        answerResult[problemNumber] = 1;
                    else
