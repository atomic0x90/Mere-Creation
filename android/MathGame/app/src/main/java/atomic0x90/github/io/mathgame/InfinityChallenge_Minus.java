...
public class InfinityChallenge_Minus extends AppCompatActivity {
    long checkTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infinity_challenge_minus);
        //Sound
        ...
        final TextView infiMTime = (TextView)findViewById(R.id.infiMTime);
        ...
        final CountDownTimer countDownTimer = new CountDownTimer(nowMilli, 1000) {
            public void onTick(long millisUntilFinished) {
                infiMTime.setText(String.format(Locale.getDefault(), "%d sec", millisUntilFinished / 1000L));
                checkTime = millisUntilFinished;
            }
            public void onFinish() {
                infiMTime.setText("Time Over");


                Intent Endintent = new Intent(getApplicationContext(), CustomDialog.class);

                if(typeString.equals("Minus6"))
                    Endintent.putExtra("Result_type","InfiM6");
                else if(typeString.equals("Minus7"))
                    Endintent.putExtra("Result_type","InfiM7");
                else if(typeString.equals("Minus8"))
                    Endintent.putExtra("Result_type","InfiM8");
                else if(typeString.equals("Minus13"))
                    Endintent.putExtra("Result_type","InfiM13");
                else if(typeString.equals("Minus16"))
                    Endintent.putExtra("Result_type","InfiM16");
                else if(typeString.equals("Minus17"))
                    Endintent.putExtra("Result_type","InfiM17");
                else if(typeString.equals("Minus6_9"))
                    Endintent.putExtra("Result_type","InfiM6_9");
                else if(typeString.equals("Minus13_17"))
                    Endintent.putExtra("Result_type","InfiM13_17");
                else if(typeString.equals("Minus6_17"))
                    Endintent.putExtra("Result_type","InfiM6_17");
        ...
        TextView nowAnswer = (TextView) findViewById(R.id.infinityMnowAnswerText);
        nowAnswer.setText(String.format(Locale.getDefault(),"정답 개수 : %d",clearNum));

        TextView firstText = (TextView) findViewById(R.id.infiMProblemText1);
        firstText.setText(String.valueOf(firstNum));

        TextView secondText = (TextView)findViewById(R.id.infiMProblemText2);
        ...
        final TextView resultText1 = (TextView)findViewById(R.id.InfiMinus_1);
        final TextView resultText2 = (TextView)findViewById(R.id.InfiMinus_2);
        final TextView resultText3 = (TextView)findViewById(R.id.InfiMinus_3);
        final TextView resultText4 = (TextView)findViewById(R.id.InfiMinus_4);
        ...
        //Button
        Button button1 = (Button)findViewById(R.id.InfiMinus_1);
        Button button2 = (Button)findViewById(R.id.InfiMinus_2);
        Button button3 = (Button)findViewById(R.id.InfiMinus_3);
        Button button4 = (Button)findViewById(R.id.InfiMinus_4);
