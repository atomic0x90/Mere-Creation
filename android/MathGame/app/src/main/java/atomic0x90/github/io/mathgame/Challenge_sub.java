...
public class Challenge_sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_challenge_sub);
        ...
        final TextView timetextView = (TextView)findViewById(R.id.subtimeText);
        ...
        final CountDownTimer countDownTimer = new CountDownTimer(11000, 1000) {
            ...
            public void onFinish() {
                ...
                {
                    Intent intent = new Intent(getApplicationContext(), Challenge_sub.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        TextView averageText = (TextView)findViewById(R.id.subAverageTime);
        ...
        if(tmpNumber == 10)
        {
            ...
            Intent Endintent = new Intent(Challenge_sub.this, CustomDialog.class);
            Endintent.putExtra("Result_type","Sub");
        ...
        {
            ImageView imageView0 = (ImageView)findViewById(R.id.subState0);
            ImageView imageView1 = (ImageView)findViewById(R.id.subState1);
            ImageView imageView2 = (ImageView)findViewById(R.id.subState2);
            ImageView imageView3 = (ImageView)findViewById(R.id.subState3);
            ImageView imageView4 = (ImageView)findViewById(R.id.subState4);
            ImageView imageView5 = (ImageView)findViewById(R.id.subState5);
            ImageView imageView6 = (ImageView)findViewById(R.id.subState6);
            ImageView imageView7 = (ImageView)findViewById(R.id.subState7);
            ImageView imageView8 = (ImageView)findViewById(R.id.subState8);
            ImageView imageView9 = (ImageView)findViewById(R.id.subState9);
        ...
        int rand1 = random.nextInt(90)+11;
        ...
        TextView resultText1 = (TextView)findViewById(R.id.csub1);
        TextView resultText2 = (TextView)findViewById(R.id.csub2);
        TextView resultText3 = (TextView)findViewById(R.id.csub3);
        TextView resultText4 = (TextView)findViewById(R.id.csub4);
        ...
        TextView  problemView1 = (TextView)findViewById(R.id.subProblemText1);
        problemView1.setText(String.valueOf(rand1));

        TextView problemView2 = (TextView)findViewById(R.id.subProblemText2);
        problemView2.setText(String.valueOf(rand2));


        //버튼 눌렀을 경우
        Button button1 = (Button)findViewById(R.id.csub1);
        Button button2 = (Button)findViewById(R.id.csub2);
        Button button3 = (Button)findViewById(R.id.csub3);
        Button button4 = (Button)findViewById(R.id.csub4);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tmpNumber != 10) {
                    ...
                    TextView resultText = (TextView) findViewById(R.id.csub1);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tmpNumber != 10) {
                    ...
                    TextView resultText = (TextView) findViewById(R.id.csub2);
                    String tmp = resultText.getText().toString();
                    if (result == Integer.parseInt(tmp))
                        answerResult[problemNumber] = 1;
                    else
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tmpNumber != 10){
                    ...
                    TextView resultText = (TextView) findViewById(R.id.csub3);
                    String tmp = resultText.getText().toString();
                    if (result == Integer.parseInt(tmp))
                        answerResult[problemNumber] = 1;
                    else
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tmpNumber != 10) {
                    ...
                    TextView resultText = (TextView) findViewById(R.id.csub4);
                    String tmp = resultText.getText().toString();
                    if (result == Integer.parseInt(tmp))
                        answerResult[problemNumber] = 1;
                    else
